...
freq_cat = df.groupby(["descCategoriaProduto"])[["idTransacao"]].count()

freq_cat["Freq. Abs. Acum."] = freq_cat["idTransacao"].cumsum()

freq_cat["Freq. Rel."] = freq_cat["idTransacao"] / freq_cat["idTransacao"].sum()
